...
import 'HarmfulInfoInsects.dart';

class HarmfulInsects extends StatefulWidget {
  const HarmfulInsects({super.key});

  @override
  _HarmfulInsectsState createState() => _HarmfulInsectsState();
}

class _HarmfulInsectsState extends State<HarmfulInsects> {
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => HarmfulIInfoScreen(prediction)),
                                );
                              },
