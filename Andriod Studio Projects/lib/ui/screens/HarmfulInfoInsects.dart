...
class HarmfulIInfoScreen extends StatefulWidget {
  final String prediction;

  const HarmfulIInfoScreen(this.prediction, {Key? key}) : super(key: key);

  @override
  _HarmfulIInfoScreenState createState() => _HarmfulIInfoScreenState();
}

class _HarmfulIInfoScreenState extends State<HarmfulIInfoScreen> {
  bool isLoading = true;
  ...
  void getPlantData(String prediction) {
    ...
    setState(() {
      plantPhotoUrl = 'assets/images/istockphoto-584236788-2048x2048.jpg';
      plantName = prediction;
      info = 'Harmful insects can cause damage to plants by feeding on them, transmitting diseases, and disrupting the plant''s growth.';
      lightNeed = 'Hard';
      lightDetails = 'Adaptable to different light conditions.';
      wateringNeed = 'Medium';
      wateringDetails = 'Water the plants every three days, keeping the soil consistently moist.';
      fertlizeNeed = 'Daily';
      fertlizeDetails = 'Use a balanced fertilizer to support the plant''s health and resilience against pests.';
          ...
          child: Column(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/heteroptera-close-up_181624-47821.jpg',
                  width: 396,
                  height: 210,
                  fit: BoxFit.cover,
                ),
