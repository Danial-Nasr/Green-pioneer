...
class SeedlingsInfoScreen extends StatefulWidget {
  final String prediction;

  const SeedlingsInfoScreen(this.prediction, {Key? key}) : super(key: key);

  @override
  _SeedlingsInfoScreenState createState() => _SeedlingsInfoScreenState();
}

class _SeedlingsInfoScreenState extends State<SeedlingsInfoScreen> {
  bool isLoading = true;
  ...
  void getPlantData(String prediction) {
    ...
    setState(() {
      plantPhotoUrl = 'assets/images/wallpaperflare.com_wallpaper (4).jpg';
      plantName = prediction;
      info = 'Seedlings are young, newly sprouted plants, often grown from seeds or cuttings.';
      lightNeed = 'High';
      lightDetails = 'Place in a location with plenty of sunlight for optimal growth.';
      wateringNeed = 'Regular';
      wateringDetails = 'Water the seedlings regularly, keeping the soil consistently moist but not waterlogged.';
      fertlizeNeed = 'Monthly';
      fertlizeDetails = 'Fertilize the seedlings weekly with a balanced liquid fertilizer.';
      isLoading = false;
    });
  }
