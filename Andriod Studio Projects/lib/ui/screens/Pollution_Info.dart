...
class PollutionInfo extends StatefulWidget {
  ...
  const PollutionInfo(this.prediction, {Key? key}) : super(key: key);
...
class _PollutionInfoState extends State<PollutionInfo> {
  ...
  void getPlantData(String prediction) {
    ...
    setState(() {
      ...
      info = 'This report outlines the current pollution levels and their impacts on the environment.';
      lightNeed = 'High';
      lightDetails = 'Place in a location with plenty of sunlight for optimal growth.';
      wateringNeed = 'Regular';
      wateringDetails = 'Adverse effects on respiratory health and overall well-being.';
      fertlizeNeed = 'Quickly';
      fertlizeDetails = 'Immediate implementation of stricter emission controls and public awareness campaigns.';
      isLoading = false;
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/pexels-pixabay-60575.jpg',
                  width: 396,
                  height: 210,
                  fit: BoxFit.cover,
                ),
